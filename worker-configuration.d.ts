/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a7d3e2afbefb5d9f56edc69b22cab44)
// Runtime types generated with workerd@1.20260401.1 2025-12-28 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QuizCrocGameDO";
	}
	interface Env {
		ASSETS: Fetcher;
		QUESTION_GENERATOR_PROVIDER: string;
		GOOGLE_AI_API_KEY: string;
		GEMINI_MODEL: string;
		OPENROUTER_API_KEY: string;
		OPENROUTER_MODEL: string;
		QUIZ_CROC_GAME_DO: DurableObjectNamespace<import("./src/index").QuizCrocGameDO>;
	}
}
